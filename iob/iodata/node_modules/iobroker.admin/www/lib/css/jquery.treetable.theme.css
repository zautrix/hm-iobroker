...
table.treetable tbody tr.active:hover,
...
table.treetable .branch.is-empty span.fancytree-expander {
  opacity: 0;
}
...
table.treetable .fancytree-icon {
  margin-right: 5px;
}
...
table.treetable .treetable-icon {
  width: 22px;
  height: auto;
}
table.treetable .treetable-icon-empty {
  width: 22px;
  height: 22px;
  display: inline-block;
}
table.treetable .treetable-center {
  text-align: center;
}
table.treetable .treetable-button-empty {
  width: 20px;
  display: inline-block;
}
table.treetable .treetable-color {
  position: absolute;
  bottom: 0;
  left: 0;
  width: calc(100% - 45px);
...
/*# sourceMappingURL=jquery.treetable.theme.css.map */
