...
# 1.1.0 (2017-06-08)
* (bluefox) BREAKING Changes: For multihost systems the user MUST explicit allow connections from other IPs in /usr/local/addons/hm-iobroker/iobroker-data/iobroker.json
...
# 0.3.15 (2015-01-09)
* (bluefox) "chmod 777 * -R /usr/local/addons/hm-iobroker" => "chmod 777 -R /usr/local/addons/hm-iobroker"
